        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className={isRTL ? 'order-2' : ''}>
            <div className="relative">
              ...
              <img src="/images/cheesy_hero.webp" alt="Cheesy Medenine" className="relative w-full h-96 object-cover rounded-3xl shadow-2xl" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/images/fallback-food.webp'; }} />
            </div>
          </div>
          <div>
