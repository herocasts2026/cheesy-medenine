...
export default function Order() {
  ...
  // دالة جلب رقم الطلب اليومي الموحد والتسلسلي من Supabase
  const generateDailyOrderNumber = async (): Promise<string> => {
    try {
      ...
      // في حال وجود مشكلة في الاتصال فقط
      return `#1`;
    }
  };
    ...
    <div className="py-20 bg-[#FAF9F6] dark:bg-[#1a1a1a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-black text-[#2C2C2C] dark:text-white">{t.yourOrder}</h1>
        </div>
